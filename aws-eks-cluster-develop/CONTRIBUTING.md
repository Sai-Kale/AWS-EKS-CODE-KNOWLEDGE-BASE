...
Please visit [SpecFlow/Terraform Modules](https://gitlab.spectrumflow.net/charter/specflow/terraform#standards) in GitLab to find the latest Code Quality, Terraform, and Project Standards. A periodic review will be performed to ensure that all projects are compliant.
